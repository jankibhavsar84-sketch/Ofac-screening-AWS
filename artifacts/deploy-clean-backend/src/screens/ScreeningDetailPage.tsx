...
export function ScreeningDetailPage() {
  ...
  async function submitBatch(e: React.FormEvent) {
    ...
    try {
      ...
      else if (name.endsWith(".xlsx")) rows = await parseExcel(batchFile);
      else throw new Error("Only CSV or XLSX files are allowed.");
  ...
  async function submitSchedule(e: React.FormEvent) {
    ...
    try {
      ...
      else if (name.endsWith(".xlsx")) rows = await parseExcel(scheduleFile);
      else throw new Error("Only CSV or XLSX files are allowed.");
